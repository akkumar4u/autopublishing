...
function App() {
  ...
  const importDoc = async () => {
    ...
    setImporting(true);
    try {
      const response = await fetch('https://autopublishing.up.railway.app/api/import', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ url: importUrl }) });
