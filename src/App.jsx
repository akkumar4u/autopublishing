...
notify(
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <div className="brand"><div className="brand-mark"><Sparkles size={17}/></div><span>publishflow</span></div>
      <div className="workspace"><span className="avatar">AC</span><span>Acme Content</span><ChevronDown size={15}/></div>
      <nav>
